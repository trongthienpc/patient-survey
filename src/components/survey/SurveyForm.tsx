...
const SurveyForm = () => {
  ...
  return (
    <Card className="w-full h-full md:h-auto md:flex-1 overflow-hidden border-0 shadow-lg sm:shadow-2xl bg-white/95 backdrop-blur-sm rounded-sm flex flex-col ring-1 ring-gray-900/5">
      <div className="flex flex-col h-full">
        {/* Khối khảo sát */}
        <div className="w-full flex flex-col h-full bg-white relative z-10">
          <div className="p-4 xs:p-5 sm:p-6 md:p-8 lg:p-10 flex flex-col h-full overflow-hidden">
            <div className="flex-1 flex flex-col min-h-0">
              {isSubmitted ? (
                <ThankYouPage />
              ) : (
                <div className="flex flex-col h-full max-w-4xl mx-auto w-full">
                  <div className="pb-4 sm:pb-6 flex-none">
                    <BoxReveal boxColor={"#a54687"} duration={0.5}>
                      <h2 className="font-bold text-xl xs:text-2xl sm:text-3xl lg:text-4xl leading-tight text-gray-900 tracking-tight">
