...
import { RenderScaleProvider } from "@/providers/RenderScaleProvider";
            ...
            <QueryProvider>
              <div className="w-full min-h-[100dvh] relative bg-white flex flex-col items-center selection:bg-primary/20">
                ...
                <div className="w-full relative z-10 flex-col flex h-[100dvh]">
                  <Header />
                  <main className="w-full h-full flex-1 flex flex-col items-center justify-start p-2 sm:p-4 md:p-4 overflow-hidden">
