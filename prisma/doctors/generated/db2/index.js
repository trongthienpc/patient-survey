...
const config = {
  ...
  "inlineSchemaHash": "1c99be5954296f2ebf0f6b70ca1aa3c7358fd66f79b49fe5b3e4daf5b5ca4515",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/doctors/generated/db2",
    "doctors/generated/db2",
  ]
...
path.join(process.cwd(), "prisma/doctors/generated/db2/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/doctors/generated/db2/schema.prisma")
